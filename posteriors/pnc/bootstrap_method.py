...
def main():
    ...
    parser.add_argument('--width-mult', type=float, default=1, metavar='wM',
    ...
    for repeat in tqdm.tqdm(range(args.repeats)):
        mean_boot, std_boot = bootstrap(args, T_POINT, T_y, N_boot, device, args.width_mult, args.verbose)
